          ...
          <div className="hidden flex-col justify-between bg-zinc-950 p-10 text-white lg:flex">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-md text-sm leading-6 text-zinc-300">
                  Set up your account, invite collaborators, and create polished
                  digital assets from one workflow.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              <p className="text-sm leading-6 text-zinc-300">
                Sign up with email or continue instantly using Google, Facebook,
                or GitHub.
              </p>
            </div>
          </div>
